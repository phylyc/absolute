...
option_list <- list(
  ...
  make_option("--maf", type = "character", default = NA, help = "somatic SNV MAF file, or a VCF (.vcf/.vcf.gz) carrying SNVs and indels [optional]", metavar = "string"),
  make_option("--indel_maf", type = "character", default = NA, help = "somatic indel MAF file [optional; ignored when --maf is a VCF]", metavar = "string"),
  ...
  make_option("--genome_build", type = "character", default = "hg19", help = "build of the genome: hg18, hg19, hg38, mm9, mm10, mm39 [default= %default]", metavar = "string"),
